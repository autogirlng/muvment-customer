    ...
    return (
        <div className={`relative ${width} ${className}`}>
            ...
            <div
                ...
                className={`flex items-center gap-1 transition-colors ${disabled
            ...
            >
                <span
                    className={`text-xs xl:text-sm transition-colors ${disabled
                            ? "text-grey-400"
                            : selectedTime
                                ? "text-grey-800"
                                : "text-grey-400"
                    ...
                    <div className="py-2 overflow-y-auto max-h-[280px] custom-scrollbar">
                        {timeOptions.map((time, index) => (
                            <div
                                ...
                                className={`px-4 py-2.5 text-sm cursor-pointer transition-colors duration-150 ease-in-out hover:bg-grey-50 ${selectedTime === time.value
