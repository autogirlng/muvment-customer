...
const DashboardDropdown: React.FC<DropdownProps> = ({
  options,
  selectedValue,
  onSelect,
  ...
  const defaultTrigger = (
    <button
      type="button"
      onClick={onToggle}
      className="w-full flex justify-between border border-gray-300 p-4 rounded-lg items-center focus:outline-none group"
    >
      <span
        className={`text-sm ${
