                    ...
                    <div className="w-full md:w-3/5 space-y-8 mt-5">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap items-center gap-4">
                                ...
                                <VehicleDetailsChip label="Vehicle type" value={vehicleDetails?.data.vehicleTypeName.replaceAll("_", " ") || "N/A"} />
                                <VehicleDetailsChip label="Seating Capacity" value={`${vehicleDetails?.data.numberOfSeats || "N/A"}`} />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                {
                                    vehicleDetails?.data.vehicleFeatures && vehicleDetails?.data.vehicleFeatures.map((feature: string) => {
