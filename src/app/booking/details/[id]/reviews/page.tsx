...
import VehicleReviewsClient from "@/components/pagesComponent/VehicleReviewsClient";
interface PageProps {
    params: Promise<{
        id: string;
    }>;
...
export async function generateMetadata({ params }: PageProps) {
    ...
    try {
        ...
        const description = `Rent ${vehicle.name} (${vehicle.year}) in ${vehicle.city
            }. ${vehicle.vehicleTypeName?.replaceAll("_", " ")} with ${vehicle.numberOfSeats
            } seats. ${features ? `Features: ${features}.` : ""
        ...
        return generatePageMetadata({
            ...
            description: "View past reviews about this rental vehicle.",
            url: `/Booking/details/${id}/reviews`,
        });
    }
}
...
export default async function VehicleDetailsPage({ params }: PageProps) {
    ...
    return <VehicleReviewsClient vehicleId={id} />;
}
